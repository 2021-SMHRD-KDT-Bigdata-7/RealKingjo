...
def index(request):
    ...
    log_list = search_log.objects.filter( author = User.id )
    my_question_list = {'question_list': question_list , 'comment_list' : comment_list, 'answer_list' : answer_list ,'log_list':log_list}
